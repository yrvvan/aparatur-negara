<h3 class="page-title">Memo Masuk</h3>
<div class="row">
    <div class="col-md-12">
        <?php echo $status; ?>
        <div class="portlet box yellow ">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-gift"></i> Form Memo Masuk
                </div>
            </div>
                ...
                <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>c_admin/tambah_srt_masuk" method="post">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" value="Memo" name="tipesurat" readonly="TRUE" required>
                            </div>
                        </div>
                    </div>
