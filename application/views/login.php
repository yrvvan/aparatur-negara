...
<html lang="en">
    ...
    <head>
        ...
        <link id="style_color" href="<?php echo base_url(); ?>assets/admin/layout2/css/themes/default_1.css" rel="stylesheet" type="text/css"/>
    ...
    <body class="login">
        ...
        <div class="logo">
            <a href="index.html">
                <img src="<?php echo base_url(); ?>assets/admin/layout2/img/logo-big-white.png" alt=""/>
            </a>
        </div>
        <!-- END LOGO -->
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="<?php echo base_url(); ?>c_admin/validate" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Username" name="usern" autofocus="true" required/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Password" name="passw" required/>
                    </div>
                </div>
